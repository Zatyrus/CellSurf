...
class AlphaShapeHelper:
    ...
    def cluster_mesh(mesh, cluster_by:str = 'area')->o3d.geometry.TriangleMesh:
        ...
        if cluster_by == 'area':
            ...
            raise NotImplementedError('The provided criterion for clustering is not implemented.')
    ...
    def repair_mesh(mesh:o3d.geometry.TriangleMesh)->o3d.geometry.TriangleMesh:
        ...
        return o3d.geometry.TriangleMesh(o3d.utility.Vector3dVector(vclean),o3d.utility.Vector3iVector(fclean))

    @staticmethod
    def make_watertight(mesh: o3d.geometry.TriangleMesh, cluster_by: str = 'area')->o3d.geometry.TriangleMesh:
        if AlphaShapeHelper.check_watertight(mesh):
            ...
            clustered_mesh = AlphaShapeHelper.cluster_mesh(cleaned_mesh, cluster_by = cluster_by)
    ...
    @staticmethod
    def iterate_until_watertight(pointCloud: o3d.geometry.PointCloud, alpha: float, cluster_by: str = 'area', max_iter: int = 10, alpha_increase_percentage: float = 0.2) -> o3d.geometry.TriangleMesh:
        ...
        with tqdm(total = max_iter, desc="Mending alpha shape") as pbar:
            for i in range(max_iter):
                ...
                mesh = AlphaShapeHelper.repair_mesh(AlphaShapeHelper.cluster_mesh(AlphaShapeHelper.clean_mesh(mesh), cluster_by = cluster_by))
                if AlphaShapeHelper.check_watertight(mesh):
        ...
        raise ValueError("Failed to find a watertight mesh after {} iterations.".format(max_iter))

    @staticmethod
    def post_process_mesh(mesh:o3d.geometry.TriangleMesh, cluster_by:str = 'area')->o3d.geometry.TriangleMesh:
        return  AlphaShapeHelper.cluster_mesh(AlphaShapeHelper.clean_mesh(mesh), cluster_by = cluster_by)