...
from cellnav.core.helpers.visual_geometry_editor import visual_geometry_editor
...
class GeometryBase(ABC):
    ...
    def visual_editor(
        ...
        """
        # Open the visualizer and get the edited geometry after the user finishes editing and closes the visualizer
        edited_geometry = visual_geometry_editor(
            self._geometry, full_screen=full_screen
        )
    ...
    def print_visualizer_key_bindings(self) -> None:
        ...
        """
        return print_visualizer_key_bindings()
